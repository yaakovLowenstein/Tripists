...
class Ion_auth
{
	 ...
	 * @author Mathew
	 */
	public function register($identity, $password, $email, $username, $additional_data = array(), $group_ids = array())
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register($identity, $password, $email,$username, $additional_data, $group_ids);
