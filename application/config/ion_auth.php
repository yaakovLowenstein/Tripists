 ...
 */
$config['site_title']                 = "TravelEnthusiasts.com";       // Site Title, example.com
$config['admin_email']                = "yalow95@gmail.com"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<p class="flash_success">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p class="flash_error">';		// Error message start delimiter
