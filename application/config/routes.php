...
$route['attractions/descriptions/(:num)'] = 'Blogs/attrDescriptions/$1';
$route['restaurants/descriptions/(:num)'] = 'Blogs/restDescriptions/$1';
...
$route['subscribe'] = 'Bloggers/subscribe';
